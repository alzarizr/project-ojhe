                  ...
                  <div class="row">
                    <div class="col-md-9">
                      <div class="img-container">
                        <img id="image" src="https://colorlib.com/polygon/gentelella/images/cropper.jpg" alt="Picture">
                      </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <a class="btn btn-primary" id="download" href="javascript:void(0);" download="https://colorlib.com/polygon/gentelella/cropped.png">Download</a>
                            </div>
                          </div>
                        </div>
                      </div><!-- /.modal -->
